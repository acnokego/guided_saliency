...
class ImageContainer:
    ...
    def load(self):
        ...
        if self.imageType == InputType.image:
            ...
            self.data = cv2.cvtColor(cv2.imread(self.filePath, cv2.IMREAD_COLOR), cv2.COLOR_RGB2BGR)
        ...
        if self.imageType == InputType.imageGrayscale:
            ...
            self.data = cv2.imread(self.filePath, cv2.IMREAD_GRAYSCALE)
            self.state = LoadState.loaded
    ...
    def getImage(self):
        ...
        if self.imageType == InputType.image:
            ...
            if self.state == LoadState.unloaded:
                ...
                return cv2.imread(self.filePath, cv2.IMREAD_GRAYSCALE)
            elif self.state == LoadState.loaded:
                return self.data
            elif self.state == LoadState.loadedCompressed:
